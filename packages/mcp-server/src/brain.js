// Filesystem operations against $BRAIN_DIR (default /srv/bizeros/brain).
// Mirrors .agents/skills/bizeros-knowledge/tools/brain_tools.py in JavaScript
// so the MCP server can talk to the brain directly without going through the
// file-api over HTTP.

import { promises as fs } from 'node:fs';
import path from 'node:path';

const BRAIN_DIR = path.resolve(process.env.BRAIN_DIR || '/srv/bizeros/brain');
